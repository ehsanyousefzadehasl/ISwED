...
c12 = Conv2D(32, (3, 3), padding='same') (u12)
c12 = LeakyReLU(alpha=0.1)(c12)
c12 = Conv2D(32, (3, 3), padding='same') (c12)
c12 = LeakyReLU(alpha=0.1)(c12)

u13 = upsample_conv(16, (2, 2), strides=(2, 2), padding='same') (c12)
u13 = concatenate([u13, c1], axis=3)
c13 = Conv2D(16, (3, 3), padding='same') (u13)
c13 = LeakyReLU(alpha=0.1)(c13)
c13 = Conv2D(16, (3, 3), padding='same') (c13)
c13 = LeakyReLU(alpha=0.1)(c13)
